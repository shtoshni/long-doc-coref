...
class StreamingUnboundedMemory(BaseMemory):
    def __init__(self, **kwargs):
        super(StreamingUnboundedMemory, self).__init__(**kwargs)
    ...
    def forward(self, mention_emb_list, mention_scores, gt_actions, metadata, rand_fl_list,
        ...
        # Initialize memory
        if memory_init:
            mem_vectors, ent_counter, last_mention_idx = self.initialize_memory(**memory_init)
        else:
        ...
        return action_logit_list, action_list, {"mem": mem_vectors, "ent_counter": ent_counter,
                                                "last_mention_idx": last_mention_idx}, last_action_str, ment_idx
