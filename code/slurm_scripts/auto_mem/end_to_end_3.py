...
mem_type_list = ['-mem_type unbounded -ignore_wt 1.0 ', '-mem_type fixed_mem -ignore_wt 0.1 ',
                 '-mem_type lru -ignore_wt 1.0 ']
...
out_dir = path.join(os.getcwd(), 'outputs/end_to_end_tuning_3')
