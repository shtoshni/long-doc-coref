...
mem_type_list = ['-mem_type ' + mem_type for mem_type in ['fixed_mem', 'lru']]
...
new_ent_wt_list = ['-new_ent_wt ' + str(new_ent_wt) for new_ent_wt in [1.0, 2.0]]


JOB_NAME = 'end_to_end'

out_dir = path.join(os.getcwd(), 'outputs/end_to_end_tuning')
